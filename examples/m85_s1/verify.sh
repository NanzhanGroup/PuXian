...
echo "== [1/5] 全能力基线 --full（宏包裹零漂移，M84 基线 9010184）=="
...
echo "== [2/5] --full --no-quic（基线 3929808）=="
...
echo "== [3/5] --full --no-quic --no-sqlite（去 sqlite3.o 1.3M，基线 2884072）=="
...
echo "== [4/5] 全裁（--no-quic + 10 模块开关 = --min 档，基线 2713472）=="
